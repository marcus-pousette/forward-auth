...
export const Spinner = () => (
    <svg
        aria-hidden="true"
        className="w-6 h-6 mr-2 text-neutral-400 animate-spin dark:text-neutral-600 fill-primary-400"
        viewBox="0 0 100 101"
        fill="none"
...
export const Content = () => {
    ...
    useEffect(() => {
        ...
        const fn = async () => {
            if (peer.identity instanceof Ed25519Keypair) {
                setMessageBody(await generateEmailBody(peer.identity))
            }

            else {
                throw new Error("Invalid identity type expected keypair of type Ed25519Keypair")
            }
        }
        fn()
